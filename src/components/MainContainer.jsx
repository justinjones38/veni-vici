  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.featureBtnContainer}>
        <button className={styles.featureBtn} onClick={() => addToBanList(cat.breeds[0].name)}>{cat.breeds[0].name}</button>
        <button className={styles.featureBtn} onClick={() => addToBanList(cat.breeds[0].weight.imperial)}>
        ...
        <button className={styles.featureBtn} onClick={() => addToBanList(cat.breeds[0].life_span)}>
